...
const OwnerPage = () => {
  useEffect(() => {
    ...
    const metaTags = {
      description: "Meet Pooja Verma & Ritika Singh, the founders of Nari Pehnawa. Discover the beautiful story of two friends who started this emerging women's Ethnic Wear brand to deliver stylish and comfortable fashion.",
      keywords: "Nari Pehnawa, Nari Pehnawa Founder, Nari Pehnawa Founders, Pooja Verma, Ritika Singh, Pooja Verma Nari Pehnawa, Ritika Singh Nari Pehnawa, About Us Nari Pehnawa, Women's Ethnic Wear, Affordable Fashion India, Women Self-reliance, Prayagraj, Deoria",
      // Open Graph Tags
      ...
      "@graph": [
        {
          ...
          "description": "Nari Pehnawa is an emerging women's Ethnic Wear brand founded by Pooja Verma and Ritika Singh, dedicated to delivering stylish and comfortable fashion to every woman.",
          "foundingDate": "2024",
          "sameAs": [
        ...
        },
        {
          ...
          "description": "Pooja Verma is the Founder of Nari Pehnawa. Her childhood dream has been to create her own identity and stand on her own feet.",
        ...
        },
        {
          ...
          "description": "Ritika Singh is the Founder of Nari Pehnawa. Her vision is to make Nari Pehnawa a trusted brand through customer satisfaction and quality products.",
            ...
            <div className="w-full md:w-1/2 flex flex-col items-center bg-white dark:bg-[#1B0606] rounded-3xl border border-[#c5a880]/20 shadow-lg overflow-hidden transition-transform duration-300 hover:-translate-y-1">
              <div className="w-full h-[320px] sm:h-[400px] relative overflow-hidden group">
                ...
                <div className="absolute bottom-4 left-6 text-white">
                  ...
                  <p className="text-[11px] sm:text-xs text-[#e2d8be] tracking-wider uppercase font-semibold">Founder, Nari Pehnawa</p>
                </div>
              </div>
              <div className="p-6 sm:p-8 space-y-4 w-full">
                ...
                <div className="text-xs sm:text-sm text-zinc-850 dark:text-zinc-200 leading-relaxed font-light italic pl-3 border-l-2 border-[#d4af37] bg-[#580C1F]/5 py-2 rounded-r-lg">
                  "As the Founder of Nari Pehnawa, I focus on delivering superior quality, innovative designs, and effortless comfort. From thoughtfully crafting each design to carefully sourcing fabrics, we prioritize excellence at every stage. Our aim is to make fashion accessible, special, and unique for every woman."
                </div>
              </div>
            </div>
        ...
        <section className="py-12 sm:py-20 max-w-[1200px] mx-auto px-4 sm:px-6 border-b border-[#c5a880]/15">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
            ...
            <div className="border-t-2 border-[#580C1F] dark:border-[#d4af37] pt-4 space-y-2 transition-transform duration-300 hover:translate-y-[-2px]">
              ...
              <p className="text-xs sm:text-sm text-zinc-800 dark:text-[#f2fcf9]/90 font-light leading-relaxed">
                Personalized query channels handled directly by the founders to build deep trust, resolving size options quickly.
              </p>
            </div>
          </div>
        </section>
