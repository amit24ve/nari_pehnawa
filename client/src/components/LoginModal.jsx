            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 py-2 sm:py-2.5 px-3 rounded-lg transition-all duration-300 hover:scale-105"
                >
                  <svg
                ...
                <button className="w-full flex items-center justify-center gap-2 bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 py-2 sm:py-2.5 px-3 rounded-lg transition-all duration-300 hover:scale-105">
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0"
                    fill="#1877F2"
                    viewBox="0 0 24 24"
