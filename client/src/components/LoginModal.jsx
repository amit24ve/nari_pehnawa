...
import { X, CheckCircle2, AlertCircle, Sparkles, ArrowRight, ShoppingBag, UserCheck, Eye, EyeOff } from "lucide-react";
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-3 py-2 pr-10 sm:px-4 sm:py-2.5 sm:pr-10 bg-white border border-gray-300 rounded-lg text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#8B0000] focus:border-transparent transition-all"
                      />
                      <button
                        type="button"
                        tabIndex={-1}
