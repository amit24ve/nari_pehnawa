                            ...
                            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-3.5 space-y-2">
                                <div className="flex justify-between items-center">
                                    <label className="text-xs font-bold text-slate-700 flex items-center gap-1.5">
                                        <Lock className="w-3.5 h-3.5 text-[#0891b2]" /> Set New Password
                                    </label>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-white border border-slate-200 rounded-xl pl-3.5 pr-10 py-2.5 text-xs sm:text-sm text-slate-800 font-mono focus:outline-none focus:border-[#0891b2] transition"
                                ...
                                <button
                                    ...
                                    className="w-full py-1.5 px-3 bg-white hover:bg-slate-100 text-slate-600 rounded-xl text-[11px] font-semibold transition flex items-center justify-center gap-1.5 border border-slate-200"
                                >
                                    <RefreshCw className="w-3 h-3 text-[#0891b2]" /> Generate Random Password
                                </button>
                            </div>
